...
function Routes() { return <RoutedErrorBoundary><Switch><Route path="/" component={HomeRedirect}/><Route path="/sign-in/*?" component={SignInPage}/><Route path="/sign-up/*?" component={SignUpPage}/><Route path="/dj-transfers/*?" component={RecipientApp}/><Route path="/app/*?" component={ProtectedApp}/><Route path="/professional/*?" component={ProfessionalApp}/><Route path="/guest/:token" component={GuestView}/><Route component={NotFound}/></Switch></RoutedErrorBoundary>; }
